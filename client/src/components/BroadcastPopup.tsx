...
export function BroadcastPopup() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <CyberCard 
          className={`relative p-0 overflow-hidden ${styles.border} bg-black/95 backdrop-blur-2xl ${styles.glow} transition-all duration-500 cursor-pointer shadow-2xl rounded-2xl md:rounded-xl`}
          onClick={() => !isExpanded && setIsExpanded(true)}
        >
          {/* Header / Notification Mode */}
          <div className={`p-3 md:p-4 ${styles.headerBg} flex items-center justify-between gap-3 border-b ${styles.border}`}>
